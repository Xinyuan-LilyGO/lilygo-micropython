...
define esp32/info
	...
	PKG_SOURCE_OPT:=--depth 1 --branch v4.4 --recurse-submodules
endef
...
define esp32/prereq
	...
	$(call Package/patches,$(TARGET_BUILD_DIR)/$(PKG_NAME),$(TOP_DIR)/target/esp32/patches)
endef
...
define esp32/install
	...
	cp $(TARGET_BUILD_DIR)/build-$(BOARD)/firmware.bin $(BIN_DIR)/esp32/$(BOARD)/$${img_name}.bin
endef
