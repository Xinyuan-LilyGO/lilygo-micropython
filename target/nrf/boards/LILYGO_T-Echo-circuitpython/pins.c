...
//    { MP_ROM_QSTR(MP_QSTR_LED1), MP_ROM_PTR(&pin_P0_13) },
    ...
    { MP_ROM_QSTR(MP_QSTR_LED3),  MP_ROM_PTR(&pin_P0_14) },

    { MP_ROM_QSTR(MP_QSTR_P0_15), MP_ROM_PTR(&pin_P0_15) },
//    { MP_ROM_QSTR(MP_QSTR_LED2), MP_ROM_PTR(&pin_P0_15) },
