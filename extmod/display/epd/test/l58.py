...
class L58():
    ...
    def clearFlags(self):
        self.bus.writeto(self.address, [0xD0, 0x00, 0xAB])
    ...
    def sleep(self):
        self.bus.writeto(self.address, bytearray([0xD1, 0x05]))

    def wakeup(self):
        self.bus.writeto(self.address, bytearray([0xD1, 0x06]))


if __name__ == '__main__':
    from time import sleep

    tp = L58(I2C(1, scl=Pin(14), sda=Pin(15)), 0x5A)
    tp.begin()
    while True:
